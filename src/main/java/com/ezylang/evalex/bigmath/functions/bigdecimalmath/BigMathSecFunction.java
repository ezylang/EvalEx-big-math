...
import static com.ezylang.evalex.bigmath.utils.BigDecimalMathExtension.toRadians;
...
public class BigMathSecFunction extends AbstractBigMathFunction {
  ...
  protected BigDecimal evaluateBigMath(MathContext mathContext, BigDecimal... parameters) {
    ...
    return BigDecimal.ONE.divide(
        BigDecimalMath.cos(toRadians(parameters[0], mathContext), mathContext), mathContext);
  }
}
