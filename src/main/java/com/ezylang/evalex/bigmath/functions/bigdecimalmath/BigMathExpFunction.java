...
/** Calculates the natural exponent of x (e<sup>x</sup>). */
@FunctionParameter(name = "x")
public class BigMathExpFunction extends AbstractBigMathFunction {

  @Override
  protected BigDecimal evaluateBigMath(MathContext mathContext, BigDecimal... parameters) {
    return BigDecimalMath.exp(parameters[0], mathContext);
  }
}
